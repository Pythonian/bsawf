...
class Plan(object):
    ...
    @classmethod
    def create(cls, id=None, amount=None, currency=None,
               interval=None, interval_count=None, trial_period_days=None,
               metadata=None, product=None):
        """
        Create a new plan.
        ...
        :type metadata: dct
        :param product: The product whose pricing the created plan represents
        :type product: dct
        :return: Stripe plan
        """
        try:
    ...
    @classmethod
    def update(cls, id=None, metadata=None):
        """
        ...
        """
        try:
            return stripe.Plan.modify(sid=id,
                                      metadata=metadata)
        except stripe.error.StripeError as e:
            print(e)
    ...
    def delete(cls, plan):
        ...
        """
        try:
            return stripe.Plan.delete(plan)
        except stripe.error.StripeError as e:
            print(e)
